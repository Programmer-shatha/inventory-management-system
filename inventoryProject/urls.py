...
urlpatterns = [
    ...
    path('profile/update/',user_view.profile_update,name='user_profile-update'),
    ...
    path('password-reset/',auth_view.PasswordResetView.as_view(template_name='user/password_reset.html'),name='password-reset'),
